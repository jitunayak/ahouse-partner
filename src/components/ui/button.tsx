...
const buttonVariants = cva(
  "inline-flex bg-gradient-to-t border-2  items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "from-primary to-primary/80 dark:from-primary dark:to-primary/80 text-primary-foreground shadow hover:opacity-90",
        destructive:
